...
class PenjualanController extends Controller
{
    ...
    public function index(SearchRequest $request)
    {
        ...
        // Menggunakan nama variabel $penjualan agar cocok dengan index.blade.php
    ...
    public function edit(Penjualan $penjualan)
    {
        ...
        abort_if($sale->status === 'COMPLETED', 403, 'Transaksi ini sudah selesai.');
    ...
    public function destroy(Penjualan $penjualan)
    {
        ...
        // Pastikan hanya transaksi bertipe OPEN yang bisa dibatalkan
        if ($penjualan->status !== 'OPEN') {
            return redirect()
                ->route('penjualan.index')
        ...
        DB::transaction(function () use ($penjualan) {
            foreach ($penjualan->itemPenjualan as $item) {
                // Kembalikan stok produk jika menggunakan sistem pengurangan stok
                if ($item->produk) {
