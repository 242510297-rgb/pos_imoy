            ...
            <div class="card-body">
                <form action="<?php echo e(route('penjualan.index')); ?>" method="GET">
                    <div class="input-group">
                        ...
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" class="form-control border-start-0"
                            placeholder="Cari transaksi berdasarkan ID..." onkeyup="this.form.submit()">
