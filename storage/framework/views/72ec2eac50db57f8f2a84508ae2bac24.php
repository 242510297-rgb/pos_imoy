    ...
    <div class="container py-4">
        ...
        <div class="card border-0 shadow-sm rounded-4 text-white overflow-hidden mb-5 position-relative"
            ...
            <div class="card-body p-4 p-md-5 d-flex flex-column justify-content-center text-center text-md-start">
                <span
                    class="badge bg-white text-primary rounded-pill px-3 py-2 fw-bold mb-3 align-self-center align-self-md-start shadow-sm">
                    Sistem Informasi Kasir
                </span>
                <h1 class="fw-bold display-5 mb-2">Tentang Aplikasi Kasir</h1>
                <p class="fs-6 opacity-90 col-lg-8 mb-0">
                    Sistem kasir (POS) terintegrasi untuk mempermudah manajemen toko, inventaris barang, kategori produk,
                    serta transaksi secara efisien.
                </p>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row align-items-center g-4">
                    ...
                    <div class="col-md-8">
                        ...
                        <h3 class="fw-bold text-dark mb-2">Toko Sepatu Step Up</h3>
                        <p class="text-muted mb-0">
                            Pusat penyedia berbagai jenis sepatu berkualitas tinggi, trendi, dan nyaman untuk segala
                            aktivitas. Kami melayani pembelian eceran maupun grosir untuk kebutuhan gaya kasual, olahraga,
                            formal, dan trend terkini.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-6 col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 text-center p-3 feature-card">
                        <div class="card-body p-2">
                            ...
                            <h6 class="fw-bold text-dark mb-1">Sepatu Santai & Sneakers</h6>
                ...
                <div class="col-6 col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 text-center p-3 feature-card">
                        <div class="card-body p-2">
                            ...
                            <h6 class="fw-bold text-dark mb-1">Lari & Olahraga</h6>
                ...
                <div class="col-6 col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 text-center p-3 feature-card">
                        <div class="card-body p-2">
                            ...
                            <h6 class="fw-bold text-dark mb-1">Formal & Pantofel</h6>
                ...
                <div class="col-6 col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 text-center p-3 feature-card">
                        <div class="card-body p-2">
                            ...
                            <h6 class="fw-bold text-dark mb-1">Sepatu Bot & Sandal</h6>
                            <small class="text-muted">Sepatu bot dan alas kaki pelindung</small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mb-5">
            <div class="text-center mb-4">
                ...
                <p class="text-muted small">Layanan sistem kasir yang mendukung operasional toko</p>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm rounded-4 text-center p-3 feature-card">
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="icon-box bg-primary bg-opacity-10 text-primary rounded-circle d-flex align-items-center justify-content-center mb-3"
                                style="width: 60px; height: 60px;">
                                <i class="bi bi-box-seam fs-3"></i>
                            </div>
                            <h5 class="fw-bold text-dark mb-2">Manajemen Produk</h5>
                            <p class="text-muted small mb-0">Kelola data stok sepatu, ukuran, warna, dan harga dengan
                                terorganisir.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm rounded-4 text-center p-3 feature-card">
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="icon-box bg-success bg-opacity-10 text-success rounded-circle d-flex align-items-center justify-content-center mb-3"
                                style="width: 60px; height: 60px;">
                                <i class="bi bi-cart-check fs-3"></i>
                            </div>
                            <h5 class="fw-bold text-dark mb-2">Transaksi Penjualan</h5>
                            <p class="text-muted small mb-0">Proses kasir yang intuitif, pencetakan nota, dan rekap
                                transaksi cepat.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm rounded-4 text-center p-3 feature-card">
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="icon-box bg-warning bg-opacity-10 text-warning rounded-circle d-flex align-items-center justify-content-center mb-3"
                                style="width: 60px; height: 60px;">
                                <i class="bi bi-shield-lock fs-3"></i>
                            </div>
                            <h5 class="fw-bold text-dark mb-2">Akses Berbasis Role</h5>
                            <p class="text-muted small mb-0">Hak akses bertingkat yang membedakan otoritas Admin dan Kasir.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm rounded-4 text-center p-3 feature-card">
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="icon-box bg-info bg-opacity-10 text-info rounded-circle d-flex align-items-center justify-content-center mb-3"
                                style="width: 60px; height: 60px;">
                                <i class="bi bi-people fs-3"></i>
                            </div>
                            <h5 class="fw-bold text-dark mb-2">Data Pelanggan</h5>
                            <p class="text-muted small mb-0">Pencatatan identitas dan preferensi pembeli untuk analisa
                                penjualan.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-5 col-lg-4">
                    <div class="card border-0 shadow-sm rounded-4 text-center p-4 feature-card">
                        <img src="<?php echo e(asset('images/p.png')); ?>" alt="Foto Pengembang"
                        ...
                        <p class="text-muted small mb-2">Pengembang Aplikasi</p>
                        <div>
                            <span
                                class="badge bg-primary bg-opacity-10 text-primary rounded-pill px-3 py-2 small fw-semibold">
                                Pengembang Utama & Desainer
                            </span>
                        </div>
                    </div>
                </div>
